...
import com.tybug.carboncopier.listeners.CreationListener;
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			JDA jda = new JDABuilder(AccountType.BOT) 
					...
					.addEventListener(new MessageListener(), new ReactionListener(), new CreationListener()) // add all the listeners
